...
const mainNews: NewsEntry[] = [
  { date: "Apr 2026", text: "Two works @ **ACL 2026** 🇺🇸: On-device end-turn detection (Main); Limitations of Causal LLMs (Findings); both led by Hyunjong" },
  ...
  { date: "Jan 2026", text: "One paper @ **ICASSP 2026** 🇪🇸: LLM for Auditory Reasoning (Oral); led by Hyunjong" },
  { date: "Nov 2025", text: "One paper @ **DATE 2026** 🇮🇹: Mixed-Precision Quantization via Iterative Search" },
