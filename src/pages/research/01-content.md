...
- **On-device LMs that can hear.** By crafting new benchmarks, we reveal that on-device LMs often lack auditory commonsense. Then, we mitigate this through retrieval and generation ([A](https://arxiv.org/abs/2509.17641), [B](https://aclanthology.org/2025.findings-acl.730/), [C](https://arxiv.org/abs/2409.08199)).
